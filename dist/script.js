...
/* harmony import */ var _modules_starterDate__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/starterDate */ "./src/js/modules/starterDate.js");
...
contentTableCurent.addEventListener("click", e => {
  e.target.classList.contains("icon-archive") && (_modules_starterDate__WEBPACK_IMPORTED_MODULE_1__["default"][_modules_starterDate__WEBPACK_IMPORTED_MODULE_1__["default"].findIndex(item => item.id === e.target.closest("tr").getAttribute("data-id"))].status = 0);
  generateContent();
});
contentTableCurent.addEventListener("click", e => {
  e.target.classList.contains("icon-delete") && _modules_starterDate__WEBPACK_IMPORTED_MODULE_1__["default"].splice(_modules_starterDate__WEBPACK_IMPORTED_MODULE_1__["default"].findIndex(item => item.id === e.target.closest("tr").getAttribute("data-id")), 1);
  generateContent();
});
generateContent();
